class LikesController < ApplicationController
  ...
  private
    ...
    def like_exist?
      Like.where(user_id: current_user.id, likeable_type: params[:like][:likeable_type], likeable_id: params[:like][:likeable_id]).exists?
    end
    ...
    def find_like
      @like = Like.find_by(likeable_id: params[:like][:likeable_id], likeable_type: params[:like][:likeable_type], user_id: current_user.id)
    end
